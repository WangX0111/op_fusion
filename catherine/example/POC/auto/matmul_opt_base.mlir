func.func @main() {
  ...
  %M = memref.dim %A, %c0: memref<1024x1024xf16> 
  %N = memref.dim %B, %c1: memref<1024x1024xf16> 
  ...
  scf.for %arg0 = %c0 to %M step %c1 {
    scf.for %arg1 = %c0 to %K step %c1 {
      ...
      memref.store %add_float, %A[%arg0, %arg1] : memref<1024x1024xf16>
    }
  }
  ...
  scf.for %arg0 = %c0 to %K step %c1 {
    scf.for %arg1 = %c0 to %N step %c1 {
      ...
      %add_int = index_cast %addm : index to i16
      %add_float = sitofp %add_int : i16 to f16
      memref.store %add_float, %B[%arg0, %arg1] : memref<1024x1024xf16>
    }
  }
  ...
  %22 = memref.cast %C : memref<1024x1024xf32> to memref<*xf32>
...
gpu.module @initC_kernel {
  gpu.func @initC_kernel(%arg0: memref<1024x1024xf32>) kernel {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %dim0 = memref.dim %arg0, %c0 : memref<1024x1024xf32>
    %dim1 = memref.dim %arg0, %c1 : memref<1024x1024xf32>
